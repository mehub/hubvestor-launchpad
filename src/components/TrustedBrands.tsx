...
const TrustedBrands = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-card dark:bg-background">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
          {brands.map((brand, index) => (
            <motion.div
              ...
              className="flex items-center justify-center p-6 rounded-lg bg-background dark:bg-card hover:shadow-md transition-all duration-300 group"
            >
              <div className="text-center">
                ...
                <div className="text-xs font-medium text-foreground">{brand.name}</div>
              </div>
            </motion.div>
          ))}
        </div>
